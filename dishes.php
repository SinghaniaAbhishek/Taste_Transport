...
<head>
    ...
    <link rel="icon" href="#">
    <title>Dishes || Taste Transport</title>
...
?>
                                ...
                                <div class="title-row">
                                    ...
                                    <?php if($item["discount"] > 0): ?>
                                        <small class="text-danger">(<?php echo $item["discount"]; ?>% off)</small>
                                    <?php endif; ?>
                                ...
                                <div class="form-group row no-gutter">
                                    <div class="col-xs-8">
                                        <?php if($item["discount"] > 0): ?>
                                            <del class="text-muted">$<?php echo number_format($item["original_price"], 2); ?></del>
                                            <span class="text-danger">$<?php echo number_format($item["price"], 2); ?></span>
                                        <?php else: ?>
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                ...
                                <?php
                                        ...
                                        ?>
                                <a href="login.php?redirect=dishes.php?res_id=<?php echo $_GET['res_id'];?>&action=check" class="btn btn-success btn-lg active">Login to Checkout</a>
                                <?php   
                                            } else {
                                        ?>
                    ...
                    <div class="menu-widget" id="2">
                        ...
                        <div class="collapse in" id="popular2">
                            ...
                            if ($result->num_rows > 0) {
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-lg-8">
                                                ...
                                                <div class="rest-descr">
                                                    <h6>
                                                        ...
                                                        <?php if($has_discount): ?>
                                                            <span class="badge badge-danger" style="font-size: 14px;">
                                                                -<?php echo number_format($product['effective_discount'], 1); ?>% OFF
                                                            </span>
                                                        <?php endif; ?>
                                                    </h6>
                                                    ...
                                                    <?php if($has_discount): ?>
                                                        <p class="text-danger">
                                                            Discount valid until: <?php 
                                                            echo date('M d, Y', strtotime($product['dish_discount_end'] ?? $restaurant['discount_valid_until'])); 
                                                            ?>
                                                        </p>
                                                    <?php endif; ?>
                                                </div>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-lg-4 pull-right item-cart-info">
                                                <?php if($has_discount): ?>
                                                    <span class="price" style="text-decoration: line-through; color: #999;">
                                                ...
                                                <a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>&action=add&id=<?php echo $product['d_id']; ?>" 
                                ...
                                echo '<div class="text-center"><p>No dishes available for this restaurant.</p></div>';
                            }
                            ?>
                        </div>
