...
<head>
    ...
    <title>Admin Panel || Taste Transport</title>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        <span><img src="images/icn.png" alt="homepage" class="dark-logo" style="max-height: 40px; width: auto;" /></span>
                    </a>
                </div>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="manage_bookings.php"><i class="fa fa-calendar" aria-hidden="true"></i><span>Table Bookings</span></a></li>
                        <li> <a href="manage_discounts.php"><i class="fa fa-percent" aria-hidden="true"></i><span>Manage Discounts</span></a></li>
                        <li class="nav-label">Reviews</li>
                        <li> <a href="admin_reviews.php"><i class="fa fa-star" aria-hidden="true"></i><span>Customer Reviews</span></a></li>
                    </ul>
                </nav>
                            ...
                            <div class="col-md-4">
                                <div class="card p-30">
                                    <div class="media">
                                        ...
                                        <div class="media-body media-text-right">
                                            <h2><?php $sql="select * from reviews";
												$result=mysqli_query($db,$sql); 
													$rws=mysqli_num_rows($result);
													
													echo $rws;?></h2>
                                            <p class="m-b-0">Customer Reviews</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body media-text-right">
                                            <h2><?php $sql="select * from bookings";
                                                ...
                                                $rws=mysqli_num_rows($result);
                                                echo $rws;?></h2>
                                            <p class="m-b-0">Table Bookings</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
