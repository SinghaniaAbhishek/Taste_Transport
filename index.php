...
<section class="popular">
    <div class="container">
        ...
        <div class="row">  
            <?php 					
                // Query for dishes with search functionality and discounts
                $query_dishes = "SELECT d.*, r.title as restaurant_name,
                                 dd.discount_percentage,
                                 CASE 
                                    WHEN dd.discount_percentage IS NOT NULL 
                                    THEN d.price * (1 - dd.discount_percentage/100)
                                    ELSE d.price 
                ...
                if (!empty($search_query)) {
                    ...
                    $query_dishes .= " WHERE d.title LIKE '%$search_term%' 
                                      OR d.slogan LIKE '%$search_term%'
                                      OR r.title LIKE '%$search_term%'";
                } else {
                    $query_dishes .= " LIMIT 6";
                }
                
                $query_res = mysqli_query($db, $query_dishes);
                ...
                if(mysqli_num_rows($query_res) > 0) {
                    while($r = mysqli_fetch_array($query_res)) {
                        ...
                        if(!empty($r['discount_percentage'])) {
                            echo '          <span class="price" style="text-decoration: line-through; color: #999;">$'.$r['price'].'</span>
                                            <span class="price" style="color: #e74c3c;">$'.number_format($r['discounted_price'], 2).' 
                                                <span class="badge badge-danger">-'.$r['discount_percentage'].'%</span>
                                            </span>';
                        } else {
                    ...
                    if (!empty($search_query)) {
                        echo '<div class="col-12 text-center"><p>No dishes found matching your search.</p></div>';
                    }
                }
            ?>
        </div>
...
<section class="featured-restaurants">
    <div class="container">
        ...
        <div class="row">
            <?php
                // Query for restaurants with search functionality
                ...
                $query_res = mysqli_query($db, $query_restaurants);
                ...
                if(mysqli_num_rows($query_res) > 0) {
                        ...
                        echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                <div class="food-item-wrap">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="price-btn-block">
                                            <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">View Menu</a>
                                        </div>
                                    </div>
                                </div>
                            </div>';
                    ...
                    if (!empty($search_query)) {
                        echo '<div class="col-12 text-center"><p>No restaurants found matching your search.</p></div>';
                    }
                }
            ?>
        </div>
